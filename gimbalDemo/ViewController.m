...
- (NSMutableDictionary *)buildGenericEvent{
    ...
    message = [NSString stringWithFormat:@"Datasnap Beacon Sighting Event Dispatched %@: At %@", currentDate(), name];
    NSLog(@"%@", message);
    DeviceLog(@"%@\n", message);
    return eventData;
}
...
- (NSMutableDictionary *)buildGeofenceArriveEvent{
    ...
    NSString *name = @"";
    NSString *message = [NSString new];
    message = [NSString stringWithFormat:@"Datasnap Geofence Arrive Event Dispatched %@: At %@", currentDate(), name];
    NSLog(@"%@", message);
    DeviceLog(@"%@\n", message);
...
- (NSMutableDictionary *)buildGeofenceDepartEvent{
    ...
    NSString *name = @"";
    NSString *message = [NSString new];
    message = [NSString stringWithFormat:@"Datasnap Geofence Depart Event Dispatched %@: At %@", currentDate(), name];
    NSLog(@"%@", message);
    DeviceLog(@"%@\n", message);
...
- (NSMutableDictionary *)buildCommunicationEvent{
   ...
   // communication event
    ...
    NSString *name = @"";
    NSString *message = [NSString new];
    message = [NSString stringWithFormat:@"Datasnap Communication Event Dispatched %@: At %@", currentDate(), name];
    NSLog(@"%@", message);
    DeviceLog(@"%@\n", message);
    return eventData;
